<%@ Page Title="" Language="C#" MasterPageFile="~/portal/member/Master.master" AutoEventWireup="true" CodeFile="RepurchaseInvoice.aspx.cs" Inherits="portal_member_RepurchaseInvoice" %>
                                            ...
                                            <asp:Panel ID="pnllead" runat="server">
                                                <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="false" AllowSorting="true" DataKeyNames="id" Width="100%" border="0" align="center" CellPadding="0" PageIndex="1" PageSize="50" OnSorting="gvUsers_Sorting" OnRowDataBound="gvUsers_RowDataBound" CellSpacing="0" CssClass="table table-striped table-bordered" OnRowCommand="gvCampaign_RowCommand">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RepurchaseOn" HeaderText="Repurchase Date">
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                </asp:GridView>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        ...
                                        <p>
                                           ...
                                           <i class="fa fa-inr"></i> <asp:Label ID="lblTotalAmt" runat="server"></asp:Label>
                                        </p>
                                        <%--<p>Discount : $10 </p>
                                    <p>Tax (10%) : $14 </p>--%>
                                        <hr />
