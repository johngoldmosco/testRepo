<%@ Page Title="" Language="C#" MasterPageFile="~/portal/member/Master.master" AutoEventWireup="true" CodeFile="rptProfitShare.aspx.cs" Inherits="portal_member_rptProfitShare" EnableEventValidation="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme"> 
                            <div class="card-header">
                                <marquee class="text-theme">Profit share will not be given on saturday, sunday and Indian Holiday`s </marquee>
                            </div>
							<div class="card-header">
