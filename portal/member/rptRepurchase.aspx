<%@ Page Title="" Language="C#" MasterPageFile="~/portal/member/Master.master" AutoEventWireup="true" CodeFile="rptRepurchase.aspx.cs" Inherits="portal_member_rptRepurchase" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Repurchase Summary</li>
        </ol>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="">
                            <asp:TextBox ID="txtTransID" runat="server" CssClass="form-control " placeholder="Trans ID"></asp:TextBox>
                        </div>
                        <div class="">
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Repurchase Summary</h6>
                            </div>
                                        ...
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
												...
												<asp:TemplateField HeaderText =" Details">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkUpdate" runat="server" Text="Click me"></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
												<asp:BoundField DataField="id" HeaderText="ID" SortExpression="id">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
												<asp:BoundField DataField="userid" HeaderText="UID" SortExpression="userid">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="pin_type" HeaderText="Product Name " SortExpression="pin_type">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Amount" HeaderText="Total Amount" SortExpression="Amount">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="gst" HeaderText="GST(in %)" SortExpression="gst">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="total_bv" HeaderText="Total BV" SortExpression="total_bv">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="epin" HeaderText="Epin" SortExpression="epin">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="gross_amount" HeaderText="Gross Amount" SortExpression="gross_amount">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="RepurchaseOn" HeaderText="Repurchase Date" SortExpression="RepurchaseOn">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
