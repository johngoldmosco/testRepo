<%@ Page Title="" Language="C#" MasterPageFile="~/portal/member/Master.master" AutoEventWireup="true" CodeFile="rptRepurchaseLevel.aspx.cs" Inherits="portal_member_rptRepurchaseLevel" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Repurchase Level Income Summary</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Repurchase Level Income Summary</h6>
                            </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ChildID" HeaderText="Child ID" SortExpression="ChildID">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="level_percent" HeaderText="Level Percent" SortExpression="level_percent">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="comm" HeaderText="comm Amount" SortExpression="comm">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="BonusDate" HeaderText="Bonus Date" SortExpression="BonusDate">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
