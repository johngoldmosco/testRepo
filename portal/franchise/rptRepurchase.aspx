<%@ Page Title="" Language="C#" MasterPageFile="~/portal/franchise/franchise.master" AutoEventWireup="true" CodeFile="rptRepurchase.aspx.cs" Inherits="portal_franchise_rptRepurchase" EnableEventValidation="false" %>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkUpdate" runat="server">Details</asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField> 
                                                ...
                                                <asp:BoundField DataField="FransID" HeaderText="Franchise ID" SortExpression="FransID">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="total_tax" HeaderText="Total Tax" SortExpression="total_tax">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="gross_amount" HeaderText="Gross Amount" SortExpression="gross_amount">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="RepurchaseDate" HeaderText="Repurchase Date" SortExpression="RepurchaseDate">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
