<%@ Page Title="" Language="C#" MasterPageFile="~/portal/franchise/franchise.master" AutoEventWireup="true" CodeFile="WalletTransaction.aspx.cs" Inherits="portal_franchise_WalletTransaction" EnableEventValidation="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Wallet Transaction</h6>
                            </div>
                                        ...
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="name" HeaderText="Name " SortExpression="name">
                                                  ...
                                                  <asp:BoundField DataField="UserSPID" HeaderText="User ID" SortExpression="UserSPID">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="debit_amount" HeaderText="Debit Amount" SortExpression="debit_amount">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="credit_amount" HeaderText="Credit Amount" SortExpression="credit_amount">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="TransType" HeaderText="Trans Type" SortExpression="TransType">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                 <asp:BoundField DataField="current_amt" HeaderText="Current Balance" SortExpression="current_amt">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
