...
public partial class portal_admin_BinarySummary : System.Web.UI.Page
{
    ...
    private DataView GetData(int intpageindex)
    {
        ...
        int count = clsOdbc.executeScalar_int("Select count(1) FROM mlm_binary_daily_payout a INNER JOIN  mlm_personal_details b ON a.userid = b.userid " + StrSearch + " ");

        strQuery = "Select c.my_sponsar_id, b.username, a.binary_date, a.left_confirmed, a.right_confirmed, a.match_comit, a.daily_matching, a.payout_amt, a.carry_forward_left, a.carry_forward_right, a.brought_forward_left, a.brought_forward_right,a.amount_given as amount_given FROM mlm_binary_daily_payout a INNER JOIN  mlm_personal_details b ON a.userid = b.userid INNER JOIN  mlm_login c ON b.userid = c.userid AND a.payout_amt > 0  " + StrSearch + " Order By a.userid DESC";
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string strQuery = "Select c.my_sponsar_id, b.username, a.binary_date, a.left_confirmed, a.right_confirmed, a.match_comit, a.daily_matching, a.payout_amt, a.carry_forward_left, a.carry_forward_right, a.brought_forward_left, a.brought_forward_right,a.amount_given as amount_given FROM mlm_binary_daily_payout a INNER JOIN  mlm_personal_details b ON a.userid = b.userid INNER JOIN  mlm_login c ON b.userid = c.userid AND a.payout_amt > 0 Order By a.binary_date DESC";
            ds = clsOdbc.getDataSet(strQuery);
