<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="repurchase.aspx.cs" Inherits="portal_admin_repurchase" %>
                    ...
                    <div class="card-body text-theme">
                        <div>
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtUserID" runat="server" CssClass="form-control" OnTextChanged="txtUserID_TextChanged" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="form-group">
