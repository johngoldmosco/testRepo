...
public partial class portal_admin_rptBV : System.Web.UI.Page
{
    ...
    private DataView GetData(int intpageindex)
    {
        ...
        int count = clsOdbc.executeScalar_int("SELECT COUNT(1) FROM mlm_progress_count_current a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid");

        strQuery = "SELECT a.userid, b.my_sponsar_id, c.username, a.left_business, a.right_business FROM mlm_progress_count_current a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid " + StrSearch + " Order By a.id DESC LIMIT " + intStart + "," + strpageSize + "";
    ...
    {
        CommonFunctions.exportFile("rptBV.xls", ".xls", gvMembers, pnllead);
    }
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string strQuery = "SELECT a.userid, b.my_sponsar_id, c.username, a.left_business, a.right_business FROM mlm_progress_count_current a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid  Order By a.id DESC";
            ds = clsOdbc.getDataSet(strQuery);
