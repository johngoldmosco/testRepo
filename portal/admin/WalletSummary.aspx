<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="WalletSummary.aspx.cs" Inherits="portal_admin_WalletSummary" EnableEventValidation="false" %>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Wallet Summary</h6>
                            </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        ...
                                        <asp:GridView ID="gvMembers" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                           ...
                                           <Columns>
                                                                ...
                                                                <asp:BoundField DataField="wallet1" HeaderText="E Wallet" SortExpression="wallet1">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                            	<asp:BoundField DataField="wallet2" HeaderText="Cashback Wallet" SortExpression="wallet2">
                                                                    <ItemStyle HorizontalAlign="Left" />
                                                                </asp:BoundField>
                                                            </Columns>
                                        </asp:GridView>
