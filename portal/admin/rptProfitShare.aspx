<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="rptProfitShare.aspx.cs" Inherits="portal_admin_rptProfitShare" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Profit Share Income Summary</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Profit Share Income Summary</h6>
                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            CssClass="table table-striped table-bordered" PageIndex="1" PageSize="25" OnRowDataBound="gvBinaryIncome_RowDataBound" OnSorting="gvBinaryIncome_Sorting">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="package_amt" HeaderText="Package Amount" SortExpression="package_amt">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="percent" HeaderText="Percent" SortExpression="percent">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="amt_comm" HeaderText="Profit Share Income" SortExpression="amt_comm">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField> 
