<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="AllTransactionsSummary.aspx.cs" Inherits="portal_admin_AllTransactionsSummary" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Transactions</h4>
                                <br />
                                <div class="row">                                    
                                    <div class="col-sm-2">
