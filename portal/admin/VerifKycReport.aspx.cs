...
public partial class portal_admin_VerifKycReport : System.Web.UI.Page
{
    ...
    private DataView GetData(int intpageindex)
    {
        ...
        int count = clsOdbc.executeScalar_int("SELECT COUNT(1) FROM mlm_kyc_documents a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE a.kyc_status=0 " + StrSearch + "");

        strQuery = "SELECT a.userid, b.my_sponsar_id, c.username,c.pancard, a.pan_card, c.aadharcard, a.aadhar_card, a.photo, a.cheque, CASE a.kyc_status WHEN 0 THEN 'Pending' WHEN 1 THEN 'Approved By admin' WHEN 2 THEN 'Reject  By admin' END AS KYCStatus, DATE_FORMAT(a.kyc_on,'%d-%b-%Y') AS KYCon, a.aadharBackside FROM mlm_kyc_documents a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE a.kyc_status!=0 " + StrSearch + "  ORDER BY a.kyc_on DESC Limit " + intStart + "," + strpageSize + "";
    ...
    protected string Search()
    {
        ...
        {
            strsel = strsel + " AND DATE(a.kyc_on) BETWEEN '" + txtStartDate.Text + "' AND '" + txtEndDate.Text + "'";
        }
    ...
    {
        CommonFunctions.exportFile("kycdoc.xls", ".xls", gvMembers, pnllead);
    }
    ...
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string strQuery = "SELECT a.userid, b.my_sponsar_id, c.username,c.pancard, a.pan_card, c.aadharcard, a.aadhar_card, a.photo, a.cheque, a.kyc_status, DATE_FORMAT(a.kyc_on,'%d-%b-%Y') AS KYCon, a.aadharBackside FROM mlm_kyc_documents a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE a.kyc_status=0  Order By a.kyc_on DESC";
            ds = clsOdbc.getDataSet(strQuery);
    ...
    {
        Response.Redirect("VerifyKyc.aspx");
    }
