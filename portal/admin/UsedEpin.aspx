<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="UsedEpin.aspx.cs" Inherits="portal_admin_UsedEpin" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Used Epins Summary</li>
        </ol>
            ...
            <div class="animated fadeIn">
                <div class="row col-sm-12">
                    ...
                    <div class="form-inline">
                        ...
                        <div class="">
                            <asp:TextBox ID="txtOwnerID" runat="server" CssClass="form-control form-control-variant  " placeholder="Owner ID"></asp:TextBox>
                        </div>
                        <div class="">
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Used Epins Details</h6>
                            </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        ...
                                        <asp:GridView ID="gvMembers" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Owner_ID" HeaderText="Owner ID" SortExpression="Owner_ID">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="epin" HeaderText="Epin" SortExpression="epin">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="epin_type" HeaderText="Epin Type" SortExpression="epin_type">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="epin_cost" HeaderText="Epin Cost" SortExpression="epin_cost">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="CreatedDate" HeaderText="Created Date" SortExpression="CreatedDate">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="UsedDate" HeaderText="Used Date" SortExpression="UsedDate">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="UsedByID" HeaderText="Used By" SortExpression="UsedByID">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
