<%@ Page Title="KYC Summary" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="rptKYCSummary.aspx.cs" Inherits="portal_admin_rptKYCSummary" %>
        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                ...
                <div class="form-group form-inline">
                    <asp:DropDownList runat="server" ID="ddlKYCStatus" CssClass="form-control col-3">
                        <asp:ListItem Value="3">Select Status</asp:ListItem>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                         <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                                ...
                                                CssClass="table table-striped table-bordered" PageIndex="1" PageSize="50" OnRowDataBound="gvReport_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="KYCStatus" HeaderText="KYCStatus" SortExpression="KYCStatus">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="kyc_on" HeaderText="KYC Status" SortExpression="kyc_on">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
