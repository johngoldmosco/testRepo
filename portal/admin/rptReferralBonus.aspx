<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="rptReferralBonus.aspx.cs" Inherits="portal_admin_rptMirrorBonus" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Referral Bonus Summary</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Referral Bonus</h6>
                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <asp:BoundField DataField="my_sponsar_id" HeaderText=" Child ID" SortExpression="USERNAME">
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="child_name" HeaderText="Child Name" SortExpression="UserName">
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
