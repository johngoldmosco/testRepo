<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="rptEpinRequest.aspx.cs" Inherits="portal_admin_rptEpinRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Epin Request Summary</li>
        </ol>
        ...
        <div class="container-fluid">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <br />
                    <div class="form-inline">
                        <asp:LinkButton ID="lnkbtnApproveRequest" runat="server" OnClick="lnkbtnApproveRequest_Click" class="">  Approve Request</asp:LinkButton>

                        <asp:LinkButton ID="lnkRejectRequest" runat="server" OnClick="lnkRejectRequest_Click" class="btn  m-l-20">  Reject Request</asp:LinkButton>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Epin Request Summary</h6>
                            </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvBinaryIncome" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="pin_type" HeaderText="Epin Type" SortExpression="pin_type">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="number_epins" HeaderText="Epin Nos" SortExpression="number_epins">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    <HeaderTemplate>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" NavigateUrl='<%# Eval("reciept_path") %>' Target="_blank"> View </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="description" HeaderText="Referrence No." SortExpression="description">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
