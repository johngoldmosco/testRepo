<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="RewardAchivers.aspx.cs" Inherits="portal_admin_RewardAchivers" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Reward Achivers</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Reward Achivers</h6>
                            </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        ...
                                        <asp:GridView ID="gvMembers" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="business" HeaderText="Reward Points" SortExpression="business">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="reward_desc" HeaderText="Reward" SortExpression="reward_desc">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="reward_value" HeaderText="Reward Value(Rs.)" SortExpression="reward_value">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="reward_on" HeaderText="Reward Date" SortExpression="reward_on">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
