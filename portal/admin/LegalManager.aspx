<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="LegalManager.aspx.cs" Inherits="portal_admin_LegalManager" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Legal Manager</li>
        </ol>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Legal Manager</h4>
                                <br />
                                <div class="row mb-2">
                            ...
                            Excel</asp:LinkButton>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 ">
									 ...
									 <div class="col-sm-2 ">
                                        <a href="LegalUpload.aspx" class="btn btn-warning m-0">Add Certificate</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <asp:LinkButton ID="lnkActive" runat="server" class="btn btn-info" OnClick="lnkActive_Click">Show Certificate</asp:LinkButton>&nbsp;&nbsp; | &nbsp;
                                    <asp:LinkButton ID="lnkDisable" runat="server" class="btn btn-danger" OnClick="lnkDisable_Click"> Hide Certificate </asp:LinkButton>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" NavigateUrl='<%# Eval("imgUrl") %>' Target="_blank"> View Certificate  </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
