...
public partial class portal_admin_rptProfitShare : System.Web.UI.Page
{
    ...
    private DataView GetData(int intpageindex)
    {
        ...
        int count = clsOdbc.executeScalar_int("SELECT COUNT(1) FROM mlm_profit_share a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE 1 " + StrSearch + "  ");

        strQuery = "SELECT a.id, a.userid, b.my_sponsar_id, c.username, a.package_amt, a.percent, a.amt_comm, a.day_count, a.created_on,a.status FROM mlm_profit_share a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE 1 " + StrSearch + "  Order By a.created_on DESC " + " LIMIT " + intStart + "," + strpageSize + "";
    ...
    {
        CommonFunctions.exportFile("rptProfitShare.xls", ".xls", gvBinaryIncome, pnllead);
    }
    protected void lnkPrint_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string strQuery = "SELECT a.id, a.userid, b.my_sponsar_id, c.username, a.package_amt, a.percent, a.amt_comm, a.day_count, a.created_on,a.status FROM mlm_profit_share a INNER JOIN mlm_login b ON a.userid=b.userid INNER JOIN mlm_personal_details c ON a.userid=c.userid WHERE 1  Order By a.created_on DESC";
            ds = clsOdbc.getDataSet(strQuery);
    ...
    {
        Response.Redirect("rptProfitShare.aspx");
    }
