<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="NewsManager.aspx.cs" Inherits="portal_admin_NewsManager" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">News Manager</h4>
                                <br />
                                <div class="row mb-2">
                            ...
                            Excel</asp:LinkButton>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 ">
									 ...
									 <div class="col-sm-2 ">
                                        <a href="AddNews.aspx" class="btn btn-warning m-0">Add News</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <asp:LinkButton ID="lnkActive" runat="server" class="btn btn-info" OnClick="lnkActive_Click">Show News</asp:LinkButton>&nbsp;&nbsp; | &nbsp;
                                    <asp:LinkButton ID="lnkDisable" runat="server" class="btn btn-danger" OnClick="lnkDisable_Click"> Hide News </asp:LinkButton>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="news_title" HeaderText="News Headline" SortExpression="news_title">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="news_desc" HeaderText="Description" SortExpression="news_desc">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
