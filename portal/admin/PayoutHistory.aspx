<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="PayoutHistory.aspx.cs" Inherits="portal_admin_PayoutHistory" %>
                        ...
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                ...
                                <div class="row">                                   
                                    ...
                                    <div class="col-sm-2">
                                        <asp:LinkButton ID="lnkbtnGenerateReport" runat="server" class="btn btn-success" OnClick="lnkbtnGenerateReport_Click"><i class="fa fa-pencil"></i>Search</asp:LinkButton>
                                    </div>
                                </div>
								<div class="">
									Total Success Amount :
									 <asp:Label ID="lblSuccess" runat="server" Text="" Font-Bold="true" Font-Size="Medium" ForeColor="Red"></asp:Label><br />
									Total Rejected Amount :
									<asp:Label ID="lblReject" runat="server" Text="" Font-Bold="true" Font-Size="Medium" ForeColor="Red"></asp:Label><br />
								</div> 
                            </div>
                            <hr />
                            <div class="card-body">
