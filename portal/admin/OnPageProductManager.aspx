<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="OnPageProductManager.aspx.cs" Inherits="portal_admin_OnPageProductManager" %>
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="#">Product Manager(On Website)</a>
            </li>
        </ol>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Product Manager (On Website)</h4>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <label class="sr-only" for="exampleInputEmail2">Product Name </label>
                                        <asp:TextBox ID="txtProdName" runat="server" class="form-control col-sm-12 " placeholder="Enter Product Name"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col-sm-2">
                                        <asp:Button ID="btnAddProduct" runat="server" CssClass="btn btn-flickr" Text="Add New Product"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Product to be shown on Website" OnClick="btnAddProduct_Click" />
                                    </div>
                                </div>
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="prod_desc1" HeaderText="Product Description" SortExpression="prod_desc1">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:BoundField>
