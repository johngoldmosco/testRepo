<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="Users.aspx.cs" Inherits="portal_admin_Users" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Active Member</h4>
                                <br />
                                <div class="row">
                                    <div class="col-sm-2">
                            ...
                            <div class="card-body">
                                <div class="row form-inline">
                                    ...
                                    <asp:LinkButton ID="lnkActive" runat="server" OnClick="lnkActive_Click" CssClass="m-lg-3">Active</asp:LinkButton>&nbsp;&nbsp;&nbsp;|
                                        ...
                                        <asp:LinkButton ID="lnkDisable" runat="server" OnClick="lnkDisable_Click" CssClass="m-lg-3">Block</asp:LinkButton>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:Panel ID="pnllead" runat="server">
                                        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="false" AllowSorting="true"
                                            DataKeyNames="userid" Width="100%" border="0" align="center" CellPadding="0" PageIndex="1" PageSize="25"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="User ID" SortExpression="my_sponsar_id">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkUserLogin" runat="server" Target="_blank" Text='<%# Bind("my_sponsar_id") %>'></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
