<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="GalleryManager.aspx.cs" Inherits="portal_admin_GalleryManager" EnableEventValidation="false" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-body">
                                <h4 class="text-theme">Gallery Manager</h4>
                                <br />
                                <div class="row mb-2">
                            ...
                            Excel</asp:LinkButton>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 ">
								 	...
								 	<div class="col-sm-2 ">
                                        <a href="GalleryUpload.aspx" class="btn btn-warning m-0">Add Photo</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <asp:LinkButton ID="lnkActive" runat="server" class="btn btn-info" OnClick="lnkActive_Click">Show Photo</asp:LinkButton>&nbsp;&nbsp; | &nbsp;
                                    <asp:LinkButton ID="lnkDisable" runat="server" class="btn btn-danger" OnClick="lnkDisable_Click"> Hide Photo </asp:LinkButton>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="false" AllowSorting="True"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink runat="server" NavigateUrl='<%# Eval("imgUrl") %>' Target="_blank"> View Photo  </asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
