<%@ Page Title="" Language="C#" MasterPageFile="~/portal/admin/Master.master" AutoEventWireup="true" CodeFile="ActiveEpin.aspx.cs" Inherits="portal_admin_ActiveEpin" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main">
        ...
        <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
            ...
            <li class="breadcrumb-item active">Active Epins Summary</li>
        </ol>
                    ...
                    <div class="col-md-12">
                        <div class="card card-accent-theme">
                            <div class="card-header">
                                <h6 class="text-theme">Active Epins (Unused) Details</h6>
                            </div>
