...
<body>
    <section class="container-pages">
        <div class="brand-logo float-left"><a class="" href="index.aspx">LifeGold</a></div>
        <div class="pages-tag-line text-white">
        </div>

        <div class="card pages-card col-lg-4 col-md-6 col-sm-6 borderimg">
            <div class="card-body ">
                <div class="h4 text-center text-theme"><strong>Login Credentials</strong></div>
                ...
                <form id="form1" runat="server">
                    <div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <asp:TextBox ID="txtUserName" runat="server" CssClass="form-control" placeholder="User Name" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Password" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                <asp:TextBox ID="txtTransPwd" runat="server" CssClass="form-control" placeholder="Trans. Password" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group form-actions">
                            <asp:Button ID="btnSignIn" runat="server" class="btn btn-primary" Text=" Click Here Sign In" OnClick="btnSignIn_Click" />
                        </div>
